...
@Component({
  selector: "app-tugasan-pegawai",
  templateUrl: "./tugasan-pegawai.component.html",
  styleUrls: ["./tugasan-pegawai.component.scss"],
})
export class TugasanPegawaiComponent implements OnInit {
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  getChart1() {
    ...
    let chart = am4core.create("tp1", am4charts.XYChart3D);
  ...
  getChart2() {
    ...
    // Create chart instance
    let chart = am4core.create("tp2", am4charts.PieChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("tp3", am4charts.XYChart);
