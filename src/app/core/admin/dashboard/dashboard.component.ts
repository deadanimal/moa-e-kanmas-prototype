...
export class DashboardComponent implements OnInit {
  ...
  navigatePage(path: String) {
    if (path == 'ladang') {
      return this.router.navigate(['/admin/ladang/pra'])
    }
    else  if (path == 'import-eksport') {
      return this.router.navigate(['/admin/import-export/pra'])
    }
    else  if (path == 'kilang-ikan') {
      return this.router.navigate(['/admin/kilang-ikan/pra'])
    }
    else if (path == 'hasilan-ikan') {
      return this.router.navigate(['/admin/hasilan-ikan/pra'])
    }
    else if (path == 'makmal-ikan') {
      return this.router.navigate(['/admin/makmal-ikan/pra'])
    }
    else if (path == 'hatcher') {
      return this.router.navigate(['/admin/hatcheri/pra'])
    }
    else if (path == 'cites') {
      return this.router.navigate(['/admin/cites/pra'])
    }
    else if (path == 'tugasan-pegawai') {
      return this.router.navigate(['/admin/tugasan-pegawai'])
    }
