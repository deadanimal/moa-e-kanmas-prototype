...
@Component({
  selector: "app-ladang-pra",
  templateUrl: "./ladang-pra.component.html",
  styleUrls: ["./ladang-pra.component.scss"],
})
export class LadangPraComponent implements OnInit, OnDestroy, AfterViewInit {
...
private map: Map;
  ...
  constructor(private _formBuilder: FormBuilder,private zone: NgZone, private modalService: BsModalService, private mapSrv: MapService,) {
  ...
  getChart1() {
    ...
    let chart = am4core.create("ladpra1", am4charts.PieChart);
  ...
  getChart2() {
    ...
    let chart = am4core.create("ladpra2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    // Create chart instance
    let chart = am4core.create("ladpra3", am4charts.PieChart);
  ...
  getChart4() {
    ...
    // Create chart instance
    let chart = am4core.create("ladpra4", am4charts.PieChart);
