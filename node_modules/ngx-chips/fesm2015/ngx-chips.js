...
function TagComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r333.editing);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(3, _c1, ctx_r333.model, ctx_r333.index))("ngTemplateOutlet", ctx_r333.template);
} }
function TagComponent_div_2_delete_icon_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TagComponent_div_2_delete_icon_3_Template_delete_icon_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r339); const ctx_r338 = ɵngcc0.ɵɵnextContext(2); return ctx_r338.remove($event); });
    ɵngcc0.ɵɵelementEnd();
} }
function TagComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown.enter", function TagComponent_div_2_Template_div_keydown_enter_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r341); const ctx_r340 = ɵngcc0.ɵɵnextContext(); return ctx_r340.disableEditMode($event); })("keydown.escape", function TagComponent_div_2_Template_div_keydown_escape_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r341); const ctx_r342 = ɵngcc0.ɵɵnextContext(); return ctx_r342.disableEditMode($event); })("click", function TagComponent_div_2_Template_div_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r341); const ctx_r343 = ɵngcc0.ɵɵnextContext(); return ctx_r343.editing ? $event.stopPropagation() : undefined; })("blur", function TagComponent_div_2_Template_div_blur_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r341); const ctx_r344 = ɵngcc0.ɵɵnextContext(); return ctx_r344.onBlurred($event); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r334.editing)("title", ctx_r334.getDisplayValue(ctx_r334.model));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r334.getDisplayValue(ctx_r334.model), " ");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r334.isDeleteIconVisible());
} }
function TagComponent_tag_ripple_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("state", ctx_r335.rippleState);
...
function TagInputDropdown_ng2_menu_item_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r346 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r349 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("innerHTML", ɵngcc0.ɵɵpipeBind2(1, 1, item_r346[ctx_r349.displayBy], ctx_r349.tagInput.inputForm.value.value), ɵngcc0.ɵɵsanitizeHtml);
} }
...
function TagInputDropdown_ng2_menu_item_2_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r346 = ctx_r353.$implicit;
    const index_r347 = ctx_r353.index;
    const last_r348 = ctx_r353.last;
    const ctx_r350 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r350.templates.first)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(2, _c2, item_r346, index_r347, last_r348));
} }
function TagInputDropdown_ng2_menu_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("value", item_r346)("ngSwitch", !!ctx_r345.templates.length);
    ɵngcc0.ɵɵadvance(1);
...
function TagInputComponent_tag_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onSelect", function TagInputComponent_tag_2_Template_tag_onSelect_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const item_r357 = ctx.$implicit; const ctx_r359 = ɵngcc0.ɵɵnextContext(); return ctx_r359.selectItem(item_r357); })("onRemove", function TagInputComponent_tag_2_Template_tag_onRemove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const item_r357 = ctx.$implicit; const i_r358 = ctx.index; const ctx_r361 = ɵngcc0.ɵɵnextContext(); return ctx_r361.onRemoveRequested(item_r357, i_r358); })("onKeyDown", function TagInputComponent_tag_2_Template_tag_onKeyDown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const ctx_r362 = ɵngcc0.ɵɵnextContext(); return ctx_r362.handleKeydown($event); })("onTagEdited", function TagInputComponent_tag_2_Template_tag_onTagEdited_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const ctx_r363 = ɵngcc0.ɵɵnextContext(); return ctx_r363.updateEditedTag($event); })("onBlur", function TagInputComponent_tag_2_Template_tag_onBlur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const i_r358 = ctx.index; const ctx_r364 = ɵngcc0.ɵɵnextContext(); return ctx_r364.onTagBlurred($event, i_r358); })("dragstart", function TagInputComponent_tag_2_Template_tag_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const item_r357 = ctx.$implicit; const i_r358 = ctx.index; const ctx_r365 = ɵngcc0.ɵɵnextContext(); return ctx_r365.dragZone ? ctx_r365.onDragStarted($event, item_r357, i_r358) : undefined; })("drop", function TagInputComponent_tag_2_Template_tag_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const i_r358 = ctx.index; const ctx_r366 = ɵngcc0.ɵɵnextContext(); return ctx_r366.dragZone ? ctx_r366.onTagDropped($event, i_r358) : undefined; })("dragenter", function TagInputComponent_tag_2_Template_tag_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const ctx_r367 = ɵngcc0.ɵɵnextContext(); return ctx_r367.dragZone ? ctx_r367.onDragOver($event) : undefined; })("dragover", function TagInputComponent_tag_2_Template_tag_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const i_r358 = ctx.index; const ctx_r368 = ɵngcc0.ɵɵnextContext(); return ctx_r368.dragZone ? ctx_r368.onDragOver($event, i_r358) : undefined; })("dragleave", function TagInputComponent_tag_2_Template_tag_dragleave_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r360); const ctx_r369 = ɵngcc0.ɵɵnextContext(); return ctx_r369.dragZone ? ctx_r369.dragProvider.onDragEnd() : undefined; });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r357 = ctx.$implicit;
    const i_r358 = ctx.index;
    const ctx_r354 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵpropertyInterpolate("draggable", ctx_r354.editable);
    ɵngcc0.ɵɵproperty("canAddTag", ctx_r354.isTagValid)("disabled", ctx_r354.disable)("@animation", ctx_r354.animationMetadata)("hasRipple", ctx_r354.ripple)("index", i_r358)("removable", ctx_r354.removable)("editable", ctx_r354.editable)("displayBy", ctx_r354.displayBy)("identifyBy", ctx_r354.identifyBy)("template", !!ctx_r354.hasCustomTemplate() ? ctx_r354.templates.first : undefined)("draggable", ctx_r354.dragZone)("model", item_r357);
...
function TagInputComponent_div_6_p_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const error_r371 = ctx.$implicit;
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(error_r371);
} }
function TagInputComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r356.theme);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r356.errors);
} }
const _c3 = ["*"];
